''' umqtt.simple2 '''
# I tried to install and use umqtt.simple2 and umqtt.robust2 directly by using upip.
# However even though installation was successful, importing umqtt.robust was failing for some reason.
# So I directly copied files along side the code and modified it suitably to keep dependency intact.
# Using umqtt.robust2 is important as it implements reconnect features -
# Without which IR remote will crash when there is connectivity issues with Broker
# This file is downloaded from https://github.com/fizista/micropython-umqtt.robust2
